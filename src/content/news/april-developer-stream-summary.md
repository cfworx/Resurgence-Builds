...
<div class="bmc-callout" style="margin: 2rem 0; padding: 1.5rem; background: var(--surface); border: 1px solid var(--accent); border-radius: 8px; text-align: center;">
  ...
  <p style="margin: 0 auto 1rem; font-size: 0.875rem; color: var(--ink-muted);">Sitting through 120 minutes of 'we're looking into it' and 'soon' just to extract these 5 bullet points physically hurt me. If my sacrifice saved you from watching the VOD at 2x speed, I'd deeply appreciate a slice of pizza in return.</p>
