...
No claim button. No special offer. No "limited time" timer counting down to make you feel worse about your life choices. Just money in your mailbox because things went sideways and Ubisoft knows it. This is the largest blanket payout we've seen from them so far, which tells you everything you need to know about how Phase 2 launch week went.
...
Translation: **a buff is being discussed.** Ubisoft is not promising timelines or numbers, but they're putting it on record mid-phase rather than waiting until Phase 3 quietly ships a new exotic and hopes everyone forgets. That's actually unusual behavior for a live-service dev team, and we're choosing to interpret it as a good sign.
...
Two ugly bugs got fixed:

- Fixed players who purchased the pass **not receiving their purchase**. If you paid real money and got nothing, you have our condolences and now also your pass.
- Fixed pass levels **costing more than the listed in-game price**. Ubisoft overcharged people on premium currency and is now fixing it. If you were hit by either of these, Ubisoft says to contact support via the in-game support button. Document your transaction ID.
...
- Exotic Weapon Tactical Augmentations Cache translations added in the Dark Zone vendor.
- Untranslated text after purchasing deals in non-English languages fixed.
- "Text not found" placeholder for the Exclusive SHD Key reward fixed.

If you've been playing in a non-English language, Phase 2 has been an *adventure* in mystery text. 1.2.1 cleans a lot of that up.
...
The Outpost Annihilation one is particularly impressive. It has been broken since beta. It is still broken. It will probably be broken when we're all old men telling our grandchildren about the time a video game made us feel things.
...
### Time-Limited Events Still Active

| Event | Location | Dates |
| --- | --- | --- |
| Dark Zone Quest | Dark Zone | May 12 – June 7 |
| OW Nest – Derelict Store (Speedrun) | Open World Nest | May 29 – June 2 |
| MM06 – Take the Castle (Speedrun) | Main Mission 06 | June 12 – June 16 |

The MM04 speedrun (May 15–19) has already ended. Don't worry about it. Grieve privately.
...
**Do not burn your recalibration materials on Strawberry Milkshake until the buff lands.** Farm the Weekly Mission Exotic Manual drops to stockpile recalibration materials now, so you're ready to move the second the updated numbers hit. We will have a dedicated build post up the moment the buff goes live.
...
- **New Phase every 6 weeks** within a season.
- **New Season every 4 months.**
...
### Speedrun Event Schedule

| Event | Mission | Dates |
| --- | --- | --- |
| OW Nest – Derelict Store | Open World Nest | May 29 – June 2 |
| MM06 – Take the Castle | Main Mission 06 | June 12 – June 16 |
| Dark Zone Quest | Dark Zone | May 12 – June 7 |
...
Patch 1.2.1 is Ubisoft's "we hear you" patch. The 500K Basic Credits and 750 Phoenix Credits compensation is the largest blanket payout the game has ever seen, and the list of acknowledged-but-not-yet-fixed issues at the bottom of the patch notes is unusually honest by live-service standards. Most studios bury those acknowledgments. Ubisoft put them in bold.

The Strawberry Milkshake buff confirmation is the most important content signal in this patch. Ubisoft is willing to revisit a flagship Pass exotic **mid-phase** rather than waiting until Phase 3 quietly makes it irrelevant. That's a good precedent.
