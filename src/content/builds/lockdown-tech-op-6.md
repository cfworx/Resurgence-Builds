...
patch: "Season 2"
tags: ["offensive-operations", "jackpot", "striker-drone"]
...
plannerHash: "s=Tech+Operator&sc=Offensive+Operations&n=The+Flashbang+Salesman&ms=gs-7&m1=Skill+Critical+Chance&m2=Skill+Critical+Damage&cs=gs-7&ct=ba-5&c1=Skill+Intensity&c2=Skill+Duration&ps=gs-7&pt=bp-2&p1=Skill+Intensity&p2=Skill+Duration&gs=gs-7&g1=Skill+Critical+Chance&g2=Skill+Critical+Damage&hs=gs-7&h1=Skill+Intensity&h2=Skill+Critical+Chance&ks=gs-7&k1=Skill+Critical+Chance&k2=Skill+Multi-Shot+Chance&w1e=ew-2&w1t=wt-35&os=os-33&sm1=smc-30&sm2=smc-23"
faqs:
  - question: "Is Tech Operator good in Division Resurgence?"
    answer: "Good at what? Killing things quickly? No. Making entire rooms of enemies wish they'd called in sick? Absolutely. Tech Operator is the slow-cooker of Division Resurgence. You don't burst anything down. You deploy systems that gradually make every enemy's life miserable until they expire from accumulated indignity. It's the most satisfying specialization if you're the type of person who sets mouse traps instead of chasing mice with a broom."
  - question: "What's the best Tech Operator build for PvE?"
    answer: "This Lockdown build. It turns every doorway and chokepoint into a no-go zone with overlapping skill deployments. Enemies walk into your setup and just... stop working. The downside is setup time. If your team rushes ahead while you're carefully placing your turret, you're going to be running to catch up while your skills sit in an empty room being useless."
  - question: "Can I play Tech Operator in PvP or the Dark Zone?"
    answer: "You can, but it requires a completely different build and a much higher tolerance for getting rushed by Vanguard players who move faster than your turret can rotate. Tech Operator PvP is about holding a position and making people regret pushing you. If they don't push, you win. If four of them push at once, you're sending a support ticket to Ubisoft. The small indie company will get back to you in 3-5 business days."
  - question: "Why does my turret keep dying in Legendary missions?"
    answer: "Because Legendary enemies target deployables with the enthusiasm of a golden retriever spotting a squirrel. Your turret has an HP bar and Legendary snipers treat it as a priority target. The fix is positioning it behind half-cover where it has line of sight on enemies but enemies can't easily line-of-sight it back. Treat your turret like a small child. It needs supervision and it will die if left unattended."
  - question: "Is Tech Operator better than Demolitionist for skill damage?"
    answer: "Tech Operator does more sustained damage over time. Demolitionist does more burst damage per rotation. If the fight lasts 10 seconds, Demolitionist wins. If the fight lasts 60 seconds, Tech Operator wins because your deployables never stop working. Legendary boss fights last 60+ seconds. You do the math."
---
...
Disoriented is the most undervalued status effect in the game. While Pulsed targets take +25% damage from you, **Disoriented targets do 50% less damage TO you**. It's a defensive multiplier that the entire team benefits from.

Most Tech builds pick Pulse for offense. This one picks Disorient and stacks the defensive shutdown so hard that your entire team can play aggressively without fearing death.

The two skills are independent: the Drone follows enemies around to bully them, while the Hive guards a fixed point like an angry bouncer. You cover both the push and the choke at the same time. Jackpot's skill crit stats apply to both.

**The Tradeoff:** Your personal weapon DPS is garbage. You are the team's force multiplier, not the carry. Accept your role as the annoying support player who makes everyone else look good while receiving zero credit at the end screen.
...
- **Gear Mods:** 6× Engineering (more gadgets, more problems)

**Jackpot 4-Piece Bonuses**

- **2-piece:** Skill Radius +12%
- **3-piece:** Skill Critical Hit Chance +10.8%
- **4-piece:** Skill Critical Hit Damage +24%
...
**Disorient Defensive Value**

| Status Effect | Bonus | Direction |
|---|---|---|
| Pulsed | +25% Damage | You deal more damage TO them |
...
| Source | Bonus | Notes |
|---|---|---|
| Jackpot 3pc | +10.8% Skill CHC | Passive, always active |
| Stabilized Flight | +6% Skill CHC | Per Drone Lock, refreshing every 20s |
| Gear rolls (Mask, Gloves, Holster, Kneepads) | Variable | Engineering cores with Skill CHC bonus |
| **Combined** | **Approaching crit cap** | EMCAT procs on nearly every burst |

**Skill Duration Stack**

| Source | Bonus | Notes |
|---|---|---|
| Deep Focus Chest | +28% Skill Duration | -10% Skill Radius tradeoff (offset by Jackpot 2pc) |
| Brainstorm Backpack | +30% Skill Duration | +15% base, +15% within 20m of ally |
| **Total** | **~58% additive** | CC uptime significantly extended |

**Full Damage and CC Stack Summary**

| Source | Effect |
|---|---|
| EMCAT 3pc | Drone crits apply Disoriented (-50% enemy damage) |
| Stabilized Flight 3pc | +6% Skill CHC per Drone Lock (keeps EMCAT proccing) |
| Concerted Strike OS | +24% Damage at 3 stacks (drone + hive hits) |
| Jackpot 3pc | +10.8% Skill CHC (passive) |
| Jackpot 4pc | +24% Skill CHD (passive) |
| Jackpot 2pc | +12% Skill Radius (offsets Deep Focus penalty) |
| Deep Focus + Brainstorm | ~58% Skill Duration (CC lasts forever) |

**The Synergy Chain**

Deploy Striker Hive at chokepoint → Send Drone to lead target → Drone Lock triggers Stabilized Flight (+6% Skill CHC) → Drone crits → EMCAT applies Disoriented → enemy accuracy tanks by 50% → Hive crits on same target pool → Concerted Strike stacks from both skill hits → +24% Damage sustained → Drone Overload pops for burst CC → Deep Focus and Brainstorm extend all Disorient durations → new targets enter, Drone Lock re-applies, Stabilized Flight refreshes → the CC loop never breaks and the enemies never get to play the game.
...
| Tier | Set | Notes |
|---|---|---|
| T0 Bridge | Jackpot 4pc + any 2pc brand | Jackpot is available from T0. Skill crit stats are online immediately. Your CC is amateur-hour but functional. |
| T1 Step | Jackpot 4pc + Deep Focus chest + Brainstorm backpack (T1) | Duration engine comes online. Disorient uptime jumps significantly. Enemies start filing formal complaints. |
| T2 Destination | Jackpot 4pc + Deep Focus + Brainstorm (T2 rolls) + Warlord exotic | Full build. T2 stat rolls push Skill CHC toward the crit cap. Warlord provides survival insurance. The entire room has permanent vertigo. |

## Combat Rotation

1. **Drop the Striker Hive** at the team's chokepoint. This is Disorient Zone 1. Enemies entering this area immediately start having the worst day of their simulated lives.
2. **Send the Striker Drone** to the lead elite. This is Disorient Zone 2. The drone follows them around like an angry ex who also happens to cause migraines.
3. **Stay within 20m of the target cluster** (where your drone/hive are hitting) to stack your Concerted Strike damage buff. Three stacks = +24% Damage. Maintain it.
4. **Fire on Disoriented targets.** They will barely fire back because they are currently experiencing severe vertigo. Your weapon damage is bad, but +24% Damage on a confused enemy is still meaningful.
5. **Pop your Drone Overload signature** to chain Disorient and drop a heavy skill damage burst when a fresh pack arrives or when the current CC is about to lapse. The duration bonuses from Deep Focus and Brainstorm ensure the Disorient persists well after Overload ends.
6. **Redeploy skills on death/expiry.** Stabilized Flight re-stacks Skill CHC within seconds of the new Drone Lock. There is minimal dead time between CC cycles.
