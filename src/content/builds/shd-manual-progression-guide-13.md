...
- **Learn weapon *feel* before damage numbers.** A weapon is not automatically strong just because its damage number is bigger. Pay attention to:
  - Stability
  - Recoil
  - Handling
  - Fire rate
...
- The game gets easier once you **stop fighting the systems** and start understanding them.
- The deeper you go, the **less progression is about loot** and the more it's about tactical understanding, efficiency, pressure management, teamwork, and system mastery.
...
- **Weapon Damage** → keeps personal damage relevant.

### Build Philosophy
- *Not* trying to out-DPS a Vanguard.
- Goal: enough damage to **solo clear content if needed**, while still being the team's primary healer.
