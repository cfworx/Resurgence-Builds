...
patch: "Season 2"
tags: ["commando", "dark-zone", "lady-death", "exotic"]
...
faqs:
  - question: "Is Lady Death the best PvP weapon in Division Resurgence?"
    answer: "For SMG-range engagements, nothing else comes close. The burst damage window when you close the gap is disgusting. The catch is that Lady Death is a Blast-type exotic, so against enemies with Shredding or Piercing weakness in PvE you're paying a damage tax. In PvP, damage type doesn't matter because players don't have weakness bars. They only have the weakness of not seeing you coming."
  - question: "How do I get Lady Death in Division Resurgence?"
    answer: "Exotic Caches, Weekly Bounty rewards, and pure uncut prayer. There is no targeted farm for Lady Death specifically. You get it when the game decides you deserve it, which based on community drop rates, is roughly after your 47th Strawberry Milkshake. Ubisoft's loot table is a small indie company's idea of generosity."
  - question: "Can I use this Lady Death build in PvE?"
    answer: "You can run it in Hard and Heroic content without issues. In Legendary, you'll feel the Blast damage tax on non-red-bar enemies and the SMG range limitation will force you into positions that get you killed. If you want a PvE Lady Death build, pair it with a Shredding-type secondary weapon and swap based on enemy color bars. Check our damage types guide for the full breakdown."
  - question: "Why is everyone running Vanguard in the Dark Zone?"
    answer: "Because Scanning Pulse is legal wallhacks and the mobility skills let you chase down extractions like a caffeinated greyhound. Every other specialization has to guess where enemies are. Vanguard players know exactly where you are, how much health you have, and whether you're worth the ammo. It's not balanced. It's just the current meta. Enjoy it before the inevitable nerf that Ubisoft will definitely implement in a timely and well-tested manner. (That was sarcasm.)"
  - question: "What's the best Dark Zone PvP strategy in Division Resurgence?"
    answer: "Travel in a group. Seriously. The DZ is designed for group play and solo players are loot pinatas. If you insist on solo DZ, run this build with max mobility, never stand still, and never start a fight you can't finish in under 3 seconds. If the fight lasts longer than 3 seconds, a third party is already sprinting toward you to clean up the scraps. The Dark Zone is a nature documentary and you are not the apex predator."
---
...
**Talent: Sentinel Aura.** Hits within 20m heal you for 600 × Toughness% (5s cooldown). This is your passive self-heal that chains through any 1v1 without requiring a skill slot. Combined with Emergency Measures on the backpack, you have two layers of "you should be dead but you aren't."
...
- **Gear Mods:** 10× Firepower, 2× Toughness

**Fury Strike 4-Piece Bonuses**

- **2-piece:** Weapon Critical Hit Damage +14.4%
- **3-piece:** Weapon Critical Hit Chance +7.2%
- **4-piece:** Rate of Fire +18%

**Fearless Warrior 2-Piece Bonus**

- **2-piece:** Damage Reduction +6%

**Core Split:** 5 Firepower + 1 Toughness. That single Toughness core on the backpack builds your 106k HP pool. The remaining Firepower cores max your weapon damage scaling.
...
**Lady Death Breathe Free Stack Ramp**

| Action | Stacks/Second | Time to Max (40) |
|---|---|---|
| Walking | 4 stacks/sec | 10 seconds |
| Sprinting | 8 stacks/sec | 5 seconds |
| Standing still | 0 | ♾️ (don't do this) |

Each consumed stack grants +15% Weapon Damage per shot. Your first 40 rounds from a full sprint carry the bonus.

**Full Damage Multiplier Stack**

| Source | Bonus | Condition |
|---|---|---|
| Breathe Free (40 stacks) | +15% Weapon Damage per shot | Moving before engagement |
| Scanning Pulse | +25% Weapon Damage + 5% Vulnerable | Pre-pulse targets |
| Vanguard 3pc | +8% Crit Chance per pulsed target | Targets within 70m |
| Assault Charge OS | +30% Firepower + 20% RoF | 20s after Signature deploy |
| Injured Concealment (10 stacks) | +18% Damage | Taking hits for 10s |
| Fury Strike 4pc | +14.4% WCHD, +7.2% WCHC, +18% RoF | Always active |
| Fearless Warrior 2pc | +6% DR | Always active |
| Sentinel Aura | 600 × Toughness% heal | Hits within 20m, 5s CD |
| Backup Battery (on swap) | +22.50% Engineering | Every 8s on swap to LD |

**Weapon Swap Cycle (The 8-Second Loop)**

| Time | Action | Effect |
|---|---|---|
| 0s | Swap to Lady Death | Backup Battery: +22.50% Engineering for 8s |
...
| DPS (estimated) | 300k+ |
| Crit Chance | ~75% |
| HP Pool (fully buffed) | ~106k |
| Damage Reduction | 6% (Fearless Warrior 2pc) |

**The Synergy Chain**

Pulse marks targets through walls → pop Tactical Link → Assault Charge gives +30% Firepower and +20% RoF → sprint toward target building 40 Breathe Free stacks → swap to Lady Death (Backup Battery procs +22.50% Engineering) → open fire consuming stacks for +15% Weapon Damage per shot → opponent shoots back → Injured Concealment ramps +1.8% per hit → Sentinel Aura heals you every 5s → swap to Type 81 when stacks are spent (Backup Protection +20% Max HP) → Lady Death auto-reloads → swap back at 8s → Backup Battery off cooldown → repeat until they're dead or you're reported.
...
4. **Open fire, moving constantly** to stack and consume Breathe Free. Watch Assault Charge and Injured Concealment start ramping your damage to absurd levels.
