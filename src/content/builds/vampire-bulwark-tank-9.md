...
faqs:
  - question: "Is Bulwark the best tank in Division Resurgence?"
    answer: "Bulwark is the ONLY tank in Division Resurgence, which makes it the best by default. It's also the most complained-about specialization in PvP because watching someone absorb your entire magazine with a shield and then one-shot you with a pistol is not most people's idea of balanced gameplay. For PvE, though, Bulwark is the reason your Legendary run doesn't end at wave 1. Respect the shield."
  - question: "Why is this Bulwark build called the Vampire?"
    answer: "Because it drains health from enemies to sustain itself, making it nearly impossible to kill as long as you keep hitting things. The self-heal loop means you can facetank damage that would instantly kill any other specialization. You are the cockroach of Division Resurgence. You simply refuse to die, and everyone hates you for it."
  - question: "Is Bulwark overpowered in PvP?"
    answer: "According to Reddit, yes. According to Bulwark mains, no. According to the actual data, Bulwark in PvP is extremely strong in 1v1 situations and extremely weak when outnumbered. The shield only faces one direction. Flank a Bulwark and they melt like ice cream in July. The problem is that in Conflict, most people run straight at the shield like it's going to politely move aside."
  - question: "Can I solo Legendary content with this Bulwark build?"
    answer: "You can solo Legendary content with this build at approximately the speed of continental drift. You will not die. You will also not kill anything quickly. A solo Legendary run on Bulwark takes roughly three times longer than a group clear because your damage output is enough to annoy enemies, not enough to threaten them. Bring friends. Or bring a podcast."
  - question: "What's the hardest counter to Bulwark in Division Resurgence?"
    answer: "Flanking. The shield faces forward. Walk around it. This has been the counter to shields in every video game since 1996 and yet every single week someone posts on Reddit asking how to beat Bulwark. The answer has not changed. It will not change. Walk. Around. The. Shield. We're begging you."
---
...
You are a mosquito. A very angry, heavily armored mosquito that refuses to die because dying would mean letting go of the trigger.
...
Plus, the Anarchy DoT means you don't even need perfect aim. Just apply stacks to some poor soul and keep shooting while the tick damage compounds. Walk away looking competent.
...
**Fearless Warrior 4-Piece Bonuses**
...
| Component | Effect |
|---|---|
| Passive regen | +0.50% Max Health/s per enemy within 10m (up to +2.50% at 5 enemies) |
| Drain on fire | −2% Health per shot consumed |
...
| Trigger | Effect |
|---|---|
| Taking damage | 70% chance to restore Health = 300% of Toughness |
| Cooldown | 2 seconds |
...
|---|---|
| 1 WCHC proc | +3.60% Max Health |
| 5 stacks | +18.0% Max Health |
| 10 stacks (cap) | +36.0% Max Health |
| Duration | 10 seconds per stack (refreshes on new crits) |

**Toughness Stack Summary**

| Source | Toughness Bonus |
|---|---|
| Fearless Warrior 4pc | +18% Toughness |
| Bulwark Watch Rank 50 | +36% Toughness |
| 12× Toughness gear mods | All core slots Toughness |
| Combat Inspiration (10 stacks) | +36% Max Health (effective HP increase) |
| **Combined effect** | HP pool so large that Happy Survival's 2% drain is pocket change |

**Anarchy DoT Stack**

| Mechanic | Value |
|---|---|
| Damage per stack | 2.40% Weapon Damage over 4.50s |
| Max stacks | 50 |
| Transfer on kill | All stacks → nearest enemy within 12m |
| LMG advantage | Maximum shots/minute = maximum stack rate |

**The Synergy Chain**

Push into pack with Ballistic Shield → enemies within 10m activate Happy Survival passive regen (+2.50% Max HP/s) → hold LMG trigger → Anarchy stacks build on primary target → Happy Survival drains 2% HP per shot for bonus damage → enemies shoot you → Unflinching procs (70% chance, heals 300% Toughness) → LMG crits trigger Combat Inspiration (building to +36% Max Health) → your HP bar is now larger than the drain → first enemy dies → Anarchy stacks transfer to next target within 12m → continue hosing → the loop never breaks because letting go of the trigger is the only thing that can kill you.
...
7. **Kill one enemy and keep hosing down the next** with fresh Anarchy stacks. The DoT transfers on death within 12m. The Unflinching heals. The LMG goes brrrr. The room gradually runs out of things that are alive.
...
3. **Combat Inspiration stacks +36% Max Health** from LMG crits, making your HP bar so large that Happy Survival's drain is a rounding error.
4. **Bulwark Watch Rank 50 is mandatory.** Without the +36% Toughness node, the math goes negative and you die. There is no debate. Go farm it.
5. **You are a mosquito.** You drain their health. They shoot you and it heals you. Nobody is having fun except you. This is the way.
