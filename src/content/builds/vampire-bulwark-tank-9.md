...
faqs:
  - question: "Why does this tank build use an LMG instead of a shotgun or SMG?"
    answer: "Because the lifesteal loop runs on shots-per-second, not damage-per-shot. The LMG fires constantly, which means Anarchy stacks build constantly, Happy Survival drains and regens constantly, and Unflinching/Combat Inspiration proc constantly. Swap to a shotgun and you'll have gaps in your healing cycle wide enough to die in. The LMG is a medical device disguised as a weapon."
  - question: "Is the Bulwark Watch Rank 50 actually mandatory?"
    answer: "Yes. Next question. Okay fine — the flat +36% Toughness from Rank 50 is what makes your HP pool large enough for Happy Survival's drain to be survivable. Without it, you're bleeding yourself dry for mediocre damage and wondering why you're face-down on the pavement. The community consensus is unanimous: 'without this one the build is useless.' Go farm it."
  - question: "Can I run this build without the Strawberry Milkshake exotic?"
    answer: "You can run a T2 PKM with Sentinel Aura + Vibrant as a budget substitute. You'll lose the Anarchy DoT spread and the build will feel like a diet version of itself, but the lifesteal core still functions. Think of it as the difference between a vampire and a guy who just drinks a lot of tomato juice."
  - question: "Why am I losing health when I shoot? Is the build broken?"
    answer: "That's Happy Survival working as intended. It drains 2% of your Health per shot to deal bonus damage equal to 0.60% of your Current Health. You're literally bleeding yourself for DPS. The trick is that your passive regen (up to 2.50% Max HP/s near enemies) plus Unflinching (300% Toughness heal on being hit) plus Combat Inspiration (+36% Max Health from crits) refills faster than you drain. You're not losing health. You're investing it."
---
