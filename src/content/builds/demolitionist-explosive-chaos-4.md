...
This is a solo-first off-meta Demolitionist build where **every single skill cast detonates twice**. Using the **Jackpot 4pc**, the **M32A1 Grenade Launcher** signature, and the **Collateral Damage OS**, this build is designed to turn your screen into a chaotic mess of fire and numbers.
...
- **Gear Mods:** 12× Engineering (More boom)

## Rotation (How to cause a Michael Bay movie)
