...
|---|---|---|
| T1 Boom Shakalaka mask/holster | Engineering core + Skill CDR or Intensity roll | Engineering primary, CDR/Intensity secondary |
| T1 Mechanical Expert chest | Toughness core + Socialite talent | Armor or Skill Duration secondary |
| T1 Mechanical Expert backpack | Engineering core + Brainstorm talent | Skill Intensity secondary |
...
Here's the pitch for every lone wolf Vanguard main who just threw up in their mouth reading the word "support."
...
4. **Engineering scales everything.** Fully Charged stacks inflate your Engineering pool. Smart Cover converts that inflated pool into team weapon damage. The build feeds itself.

## How the Skills Work Together

**Tactical Smart Cover converts 24% of your Engineering into Weapon Damage for every agent behind the cover.** The higher your Engineering, the bigger the weapon damage bonus your whole team gets. Base skill cooldown is 50 seconds, but with all your CDR it comes back much faster.
...
The team's DPS doesn't just go up. It multiplies across three separate buff stages. The individual numbers look modest. The combined output is disgusting.
...
Foxhole is the sleeper pick here. The higher your Engineering, the more extra health every teammate gets per weapon hit while behind your Smart Cover. Your teammates become borderline unkillable while standing in your cover. This is why the build dominates Legendary missions, you're behind cover the entire time.

## Combat Rotation

This is the exact sequence. Memorize it like your middle school locker combo.

**Pre-engage:**

1. Move within range so Scanning Pulse will cover the enemy group.
2. Drop Tactical Smart Cover on the position your team will ACTUALLY USE. Not your favorite corner. The spot your teammates are going to naturally gravitate toward.
...
7. Keep firing P90. Empty again. Reload. **Stack 2.**
8. One more empty mag. Reload. **Stack 3, max.** +22.50% total Engineering from Fully Charged.

**Phase 3 (Tactical Link window):**

9. Pop Tactical Link the moment it's available. Bugle Call slaps +14.4% RoF, Damage Reduction, and Movement Speed on the whole team. Smart Cover is converting your inflated Engineering. Pulse is still up. Everything is firing at once.
10. During Link, fire continuously. Mobile Bastion generates team Signature charge per kill. Scout chip generates team Sig charge per Pulse.
...
By three rotations deep in a long mission, your team feels like they're cheating. That's the build working as intended.
