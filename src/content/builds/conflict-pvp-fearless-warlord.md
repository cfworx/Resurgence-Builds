...
patch: "Season 2"
tags: ["conflict", "commando", "warlord", "exotic"]
...
faqs:
  - question: "Why does the Warlord feel like I'm shooting a garden hose at first?"
    answer: "Because you're not firing long enough. Play Rough's 25% DR kicks in the moment you pull the trigger and Recycling feeds you bullets while you take damage. The longer you hold that trigger, the more immortal you become. Stop burst-firing like it's a marksman rifle — this is an LMG cosplaying as an AR."
  - question: "Can I run this in ranked Conflict or is it going to get nerfed?"
    answer: "Willspot went 24-0 with it on stream. Twice. If they haven't nerfed it yet, they're either scared of the community backlash or nobody at Ubisoft watches Twitch. Either way, abuse it while it's hot."
  - question: "What do I do when someone runs a shield build against me?"
    answer: "Throw both grenades at their feet for the +36% RoF from Explosive Fury, then just hold the trigger. The Warlord's sustained DPS with Recycling will chew through their shield HP faster than they expected. If they turtle, flank — you have 29.5% DR while firing, they don't have eyes on their sides."
  - question: "Is Fearless Warrior 4pc better than running 4pc Fury Strike for PvP?"
    answer: "In Conflict? Absolutely. Fury Strike wants you to crit-fish and stay mobile. Fearless Warrior wants you to stand your ground and out-trade everyone. In a mode where spawn-trapping is the win condition, surviving the 1v1 matters more than flashy burst damage. You're not trying to clip — you're trying to win."
---
...
- **Gear Mods:** 8× Firepower, 4× Toughness

**Fearless Warrior 4-Piece Bonuses**

- **2-piece:** Damage Reduction +6%
- **3-piece:** Damage Bonus +9%
- **4-piece:** Toughness +18%

**Phalanx Attack 2-Piece Bonus**

- **2-piece:** Magazine Size +18%

**Core Split:** 4 Firepower + 2 Toughness. Put your damage on the Mask, Chest, Holster, and Gloves. Put your survival on the Backpack and Kneepads.
...
These aren't for damage. They're for proccing Explosive Fury. Throw them before the engagement starts to stack +36% RoF. If they happen to hit someone, great. If not, you still got your buff. The frag's area denial also forces enemies out of cover and into your firing lane, which is exactly where the Warlord wants them.

## How It Works (The Math)

**Fearless Warrior Defensive Stack**

| Source | Bonus | Condition |
|---|---|---|
| Fearless Warrior 2pc | +6% DR | Always active |
| Play Rough (Warlord) | +25% DR | While firing |
| **Combined DR** | **~29.5% DR** | While firing (multiplicative) |

**Offensive Multiplier Stack**

| Source | Bonus | Condition |
|---|---|---|
| Fearless Warrior 3pc | +9% Damage | Always active |
| Explosive Fury (2 stacks) | +36% Rate of Fire | 10s after grenade throw |
| Recycling | Mag sustain (4.5 bullets/hit) | Enemy shooting you within 20m |
| Phalanx Attack 2pc | +18% Magazine Size | Always active |
| Assault Charge OS | +30% Firepower, +20% RoF | 20s after Signature deploy |

**Effective TTK Advantage**

| Scenario | Your TTK | Their TTK vs You |
|---|---|---|
| Pure DPS opponent (0% DR) | Baseline | +29.5% longer to kill you |
| Tank opponent (15% DR) | Slightly longer | +29.5% longer to kill you |
| Mirror match (Fearless Warrior) | Even | Whoever procs Explosive Fury first wins |

**The Synergy Chain**

Pre-throw grenades → Explosive Fury stacks +36% RoF → open fire with Warlord → Play Rough's 25% DR activates → opponent shoots back → Recycling refills your mag from their bullets → Fearless Warrior 4pc gives +18% Toughness on top of the DR → you out-trade them in sustained fire → they die → you spawn-trap their team → they report you → you go 24-0.
...
5. **Willspot went 24-0 with this. Twice.** If you can't go positive with this build, the problem is between the chair and the screen.
