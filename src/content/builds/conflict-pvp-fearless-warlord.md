...
- **Gear set:** **4pc Fearless Warrior + 2pc Striker**
- **Stat priority:** Weapon Crit Damage → Weapon Crit Chance → Weapon Damage → Toughness
- **Gear Core:** Mixed Firepower + Toughness (3:3 split, balanced bruiser)

> **Build stats (Willspot's setup):** DPS 89,000 · Armor 2.4k · Health 47,000 · Level 36 (T1 gear, room to grow into T2)
...
The Warlord is a **gold/exotic Tier 1 AR**. Its rolled stats from Willspot's loadout:
...
| Slot | Item | Talent / Notes |
|---|---|---|
| **Mask** | Fearless Warrior | Firearms mod (346 Health, 49 Armor, 11 Firepower) |
| **Chest** | Striker | **Recycle** talent + Engineering gear mod |
| **Backpack** | Fearless Warrior | **Explosive Fury** talent + Toughness Mod (12 Tough, 320 HP, 51 Armor) + Health Mod |
...
### Holster (Fearless Warrior)
- **Core:** Firepower
- **Bonus 1:** Weapon Crit Chance
- **Bonus 2:** Skill Cooldown Recovery

### Gloves (Gold, brand-agnostic)
- **Core:** Firepower
- **Bonus 1:** Damage to Elites
- **Bonus 2:** Skill Cooldown Recovery

### Kneepads (Fearless Warrior)
- **Core:** Toughness
...
- **DPS: 89,000**
- **Weapon Crit Damage: +37.68%** (16.11 Warlord + 12.77 MPX + Mask 8.8 ≈ 37.68%)
- **Weapon Crit Chance:** ~50% (from gear + Vanguard pulse synergy if applied)
- **Multi-Shot Chance: 2.25%** (just kneepad roll)
- **Fearless Warrior 4pc:** +9% Weapon Damage

### Target survivability (typical PVP opponent):
- ~40,000-50,000 HP
- ~2,000-3,000 Armor
...
Incoming damage taken while firing:
- Play Rough: −25% damage
- Fearless Warrior 4pc: −6% damage
- **Combined: 70.5% damage taken (29.5% reduction)**

Against a target running 89k DPS back at you:
- Effective incoming DPS while you fire: ~63,000
- Your effective HP: ~47k HP + 2.4k Armor = ~50k effective HP
- **Time for the enemy to kill you while you fire: ~790ms**

**You delete them at 590ms. They delete you at 790ms.** That 200ms gap is the entire match. You win every 1v1 that starts symmetrically.
...
> *"Play Rough: Firing reduces incoming damage by 25%. When firing, apply 60% of the reduced damage [as return damage] and grants +10% Skill Damage for 10 seconds."*

Three effects, all active while you fire:
...
- 60% of the damage you would have taken (the 25% reduced portion) is **dealt back to the attacker** as return damage
- This is silent extra DPS layered on top of your weapon damage
- Against a focused attacker, you are doing more damage than your DPS counter shows

### 3. The +10% Skill Damage buff (10s)
- Refreshes every time you fire
- Boosts your Shield's regenerated HP and grenade damage by 10%
- Effectively permanent uptime if you are firing constantly

**Without Warlord and Play Rough, the build is just a generic Fearless Warrior loadout. Play Rough is the difference between meta-tier and average.**
...
The math: in a 1v1, you take constant low-grade damage (chip damage from the enemy spraying). Every chip hit has an 80% chance to refill 4.5% of your mag. Across a typical engagement (15-20 incoming hits), you effectively get **a free magazine refill** without ever pausing to reload. This is **the** PVP talent for sustained-fire builds.
...
## Sensitivity & Graphics Settings

Willspot's exact settings, in case you want to copy them:

**Input:** PS5 DualSense controller, Bluetooth
**Control UI:** On
...
**Graphics:**
- Quality: Medium (Willspot's recording setup; recommends Low for everyone else for 60 FPS lock)
- Frame Rate: 60 FPS
- Shadow Quality: Low
- VFX: Low
- Bloom: Off
...
### Engage
4. **Deploy Shield** when first enemy is visible. Plant it on the angle they will push.
5. **Throw second grenade.** Explosive Fury **2nd stack** (+36% RoF total for 10s).
6. **Open fire with Warlord** the instant the enemy is in line of sight. Play Rough activates the moment your first bullet leaves the gun → 25% DR is now live.
7. **Recycle proc** refills your magazine as you take return fire.
8. **MPX swap** if the enemy gets inside 10m.

### Re-engage
9. **Move to the next spawn lane.** Repeat. Grenade cooldown should be back up by the time the next wave spawns.
10. **Never stop firing.** Even when no enemy is visible, fire at corners and walls to maintain Play Rough's 25% DR and your Explosive Fury stacks.

---

## The Lady Death Alternative
...
- Keep MPX as secondary
- The rest of the build (4pc Fearless Warrior + 2pc Striker, Recycle, Explosive Fury) stays identical
- You lose Play Rough's 25% DR layer
- You gain Lady Death's **Breathe Free** talent (15% weapon damage)
- Net: lower survival, higher damage. More glass-cannon than bruiser, but still meta-viable

This is the F2P-friendly path. We have a dedicated build guide for the Dark Zone Lady Death build elsewhere on the site.
...
- **MPX (purple):** Steady Hands

**Recalibration priority:**
1. Get the 4pc Fearless Warrior set bonus first
2. Get Warlord (or Lady Death as alternative)
3. Fix Recycle + Explosive Fury talents
4. Get Striker chest with Weapon Damage roll
5. Then optimize all bonus stats
...
3. **Pre-throw grenades.** Explosive Fury 2 stacks = +36% Rate of Fire. Free DPS for 10 seconds per pre-throw.
4. **You out-TTK the lobby.** 590ms target deletion vs 790ms enemy deletion of you. That 200ms gap is your win condition.
5. **Lady Death is the F2P alternative.** 17,500 DZ credits. Loses Play Rough but is still meta-tier.
