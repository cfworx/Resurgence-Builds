...
faqs:
  ...
  - question: "What shotgun should I use for this Division Resurgence build?"
    answer: "Any shotgun with high per-pellet damage and the right talent roll. The specific weapon name matters less than the talent synergy. Look for Duration Downpour or any talent that stacks damage per hit. The shotgun is a delivery mechanism for talents. The talents are the actual build. If your shotgun has bad talents, it's just a loud noise maker."
