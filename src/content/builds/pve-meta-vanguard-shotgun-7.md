...
faqs:
  - question: "Why a Double Barrel instead of a pump shotgun with higher per-pellet damage?"
    answer: "Because the Double Barrel fires two shells per trigger pull. Each shell can independently proc Multi-Shot and Explosive Round. You're not pulling a trigger — you're filing a noise complaint against yourself. Pump shotguns hit harder per pellet, but they don't delete health bars in one input event. We're speed-running existence here."
  - question: "I keep dying before I can fire a single shot. What gives?"
    answer: "You're playing a glass cannon that needs to be within 15 meters of things that want you dead. If you don't have a Bulwark teammate absorbing aggro, or you're not using Smart Cover, you are volunteering to be a loot piñata. Patience. Let the tank go first. You're the follow-up punch, not the opening act."
  - question: "Can I run this without Tactical Link?"
    answer: "You can run it without pants too, but why would you? Tactical Link's +20% Crit Chance window is where the build goes from 'really good' to 'YouTube clip material.' Without it, you're just a guy with a shotgun. With it, you're a deletion algorithm with legs."
  - question: "Is Explosive Round OS actually better than Dominating Presence here?"
    answer: "Dominating Presence gives Multi-Shot — nice. Explosive Round gives a 5m AOE nuke on every aimed crit. Since the Double Barrel fires two shells and each can trigger Multi-Shot, you're looking at multiple simultaneous 2,000% Firepower detonations per trigger pull. It's not even close. One is a nice bonus. The other is a war crime."
---
