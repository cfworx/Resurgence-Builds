...
6. [Why There Is No Team-DR Engine](#why-no-team-dr)
7. [Why Pure Throughput Wins](#why-pure-throughput)
8. [Team Buff Cascade — What Allies Actually Feel](#team-buff-cascade)
9. [Skill Mod & OS Choices](#skill-mods-and-os)
10. [Why Deep Focus Earns the Chest Slot](#why-deep-focus)
11. [Gear Set Ladder](#gear-set-ladder)
12. [Combat Rotation](#combat-rotation)
13. [The "Most Sought-After Healer" Pitch](#the-pitch)
14. [Loot Quick-Reference Sheet](#loot-reference)
15. [TL;DR — Five Things to Remember](#tldr)
...
| +9.6% Skill Intensity | Mutual Support (Hive deployed, ally <20m) | × 1.096 |
...
| +40% Incoming Healing | Effective Triage (ally <50%) | × 1.40 |
| +14.4% Received Healing | Healing Elites 2pc | × 1.144 |
