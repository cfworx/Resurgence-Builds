...
<div class="bmc-callout" style="margin: 2rem 0; padding: 1.5rem; background: var(--surface); border: 1px solid var(--accent); border-radius: 8px; text-align: center;">
  ...
  <p style="margin-bottom: 1rem; font-size: 0.875rem; color: var(--ink-muted);">I combed through 10 pages of unformatted patch notes to figure out if your favorite gun got nerfed into the ground. (Spoiler: it probably did). If I saved you from squinting at Ubisoft's tiny font, buy me a pizza.</p>
