...
<div class="bmc-callout" style="margin: 2rem 0; padding: 1.5rem; background: var(--surface); border: 1px solid var(--accent); border-radius: 8px; text-align: center;">
  <h3 style="margin-top: 0; margin-bottom: 0.5rem; color: var(--accent);">Translating dev-speak makes me violently hungry</h3>
  <p style="margin: 0 auto 1rem; font-size: 0.875rem; color: var(--ink-muted);">I combed through 10 pages of unformatted patch notes to figure out if your favorite gun got nerfed into the ground. (Spoiler: it probably did). If I saved you from squinting at Ubisoft's tiny font, buy me a pizza.</p>
...
**Original source:** Ubisoft (official), [PHASE 2 STARTS NOW — WHAT'S NEW](https://www.ubisoft.com/en-us/game/the-division/resurgence/news-updates/3ygDDXxg6dv6aQD5MJvbKv/phase-2-starts-now-whats-new)
